...
function Forecasts(props) {
    ...
    const LINK = `https://api.openweathermap.org/data/2.5/forecast?lat=${props.cords['lati']}&lon=${props.cords['long']}&units=metric&appid=6d57a0f4b9fd51c5ed98839bdd81ef26`;
